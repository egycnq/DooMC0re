...
int key_weapon7 = '7';
int key_weapon8 = '8';
/* Bound to the values dg_platform.c sends for L1/R1. These defaulted to 0,
   which no key event can ever equal, so pad weapon-switching was dead
   unless a config file happened to set them. */
int key_prevweapon = ',';
int key_nextweapon = '.';
