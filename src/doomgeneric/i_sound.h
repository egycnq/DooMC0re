...
#endif
#ifdef FEATURE_DG_SOUND
/* PS5 SFX backend (src/dg_sound.c). Deliberately NOT gated on FEATURE_SOUND:
   that macro also pulls in <SDL_mixer.h>, DG_music_module and the
   libsamplerate config vars, none of which exist in this freestanding build. */
extern sound_module_t DG_sound_module;
/* PS5 OPL2 music backend (src/dg_musicmod.c + dg_music.c + dg_opl.c) */
extern music_module_t DG_music_module;
#endif
