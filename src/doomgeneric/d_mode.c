...
static struct {
    ...
    // These three were missing while there was no netgame to notice. d_main.c's
    // gameversions[] still offers them to -gameversion, and a version this
    // table rejects makes the server drop GAMESTART without a word.
    { doom,     exe_doom_1_666 },
    { doom,     exe_doom_1_7 },
    { doom,     exe_doom_1_8 },
    { doom,     exe_doom_1_9 },
